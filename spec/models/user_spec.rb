  ...
  context 'Authentication' do
    ...
    describe "::confirm" do
      it "checks if a specified user & password combination exists" do
        ...
        expect(User.confirm(user_email, user_password)).to eq(found_user)
      end
      it "checks if a specified user & password combination exists" do
        user_email = "shmee@me.com"
        user_password = "ijnamuj"
        found_user = User.find_by_email(user_email)
        expect(User.confirm(user_email, user_password)).not_to eq(found_user)
      end
    end
  end
